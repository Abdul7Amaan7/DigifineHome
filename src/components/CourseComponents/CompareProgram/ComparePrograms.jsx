      ...
      <div className="flex flex-col xs:px-4 xs:py-8 max-w-6xl w-full mx-auto px-6 md:px-0 md:my-spacing20 mt-16">
        ...
        <div className="flex flex-col justify-start items-start w-full md:gap-0 xs:gap-2 mb-6 md:mb-8">
          ...
          <div className="w-full">
            <p className="font-semibold text-2xl md:text-4xl tracking-tight md:leading-tight">
              {subtitlePart1} <span className="text-primary-main">{subtitleHighlight}</span>
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row w-full mt-8 md:mt-12 justify-center items-center gap-3 md:gap-5">
          <button className="h-11 justify-center items-center gap-2 inline-flex whitespace-nowrap bg-white rounded-lg border border-greyscale-4 text-greyscale-main font-medium px-4 py-2.5 w-full md:w-[300px] hover:bg-greyscale-5 transition-colors">
            {button1Text}
          </button>
          <button className="h-11 justify-center items-center gap-2 inline-flex whitespace-nowrap bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg shadow-lg text-white font-medium px-4 py-2.5 w-full md:w-[300px] hover:opacity-90 transition-opacity">
            {button2Text}
          </button>
        </div>
      </div>

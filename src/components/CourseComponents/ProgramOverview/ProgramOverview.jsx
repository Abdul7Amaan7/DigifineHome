...
//     },
//     // Add other default highlights
//   ],
//   readMoreText = "Read More"
// }) => {
//   return (
//     <section className="md:max-w-1440 md:m-auto px-spacing20 ">
//       <div className="flex flex-col xs:px-spacing20 xs:my-spacing4 max-w-1440 max-w-6xl w-full mx-auto md:my-spacing16 rounded-2xl bg-greyscale-white shadow-custom xs:shadow-lg md:py-spacing8 md:px-spacing24 md:rounded-16 rounded-10 px-spacing2 py-3">
...
//             <h2 className="font-semibold text-3xl -tracking-0.44 gap-spacing8 md:text-heading3 xs:text-title2 md:-tracking-0.32 xs:-tracking-0.175 whitespace-break-spaces">
//               {titlePart1} <span className="text-primary-main">{titleHighlight}</span>
//             </h2>
//           </div>
//         </div>

//         <div className="md:text-bodyNormal xs:text-bodySmall md:pt-spacing4 xs:pt-spacing24 font-450 md:-tracking-0.16 xs:-tracking-0.14 content-widget">
//           <div className="line-clamp-4">
//             {paragraphs.map((para, index) => (
//               <p key={index} className="CertTheme__paragraph" dir="ltr" data-mode="standard">
//                 <span>{para}</span>
//               </p>
//             ))}
...
//                   key={index}
//                   value={index + 1}
//                   className="CertTheme__listItem mt-2"
//                 >
...
//             <button className="md:text-buttonSmall xs:text-captionSmall font-450 text-primary-main underline md:-tracking-0.16 xs:-tracking-0.105 cursor-pointer">
//               {readMoreText}
//             </button>
//           </div>
//         </div>
